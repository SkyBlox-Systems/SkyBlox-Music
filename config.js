...
module.exports = {
	 ...
	 * @type {string | string[]} */
	ownerId: process.env.DEVUID || ["406164395643633665"],
	/** 
	 * Token for bot login
	 * @type {string} */
	 ...
	 * ID of the bot
	 * @type {string} */
	clientId: process.env.CLIENTID || "1230780049792307200",
	/** 
	...
	api: {
		 ...
		 * @type {number} */
		port: parseInt(process.env.API_PORT) || 1101,
	},
	...
	ws: {
		 ...
		 * Port to run WS on
		 * @type {number} */
		port: parseInt(process.env.WS_PORT) || 1102,
	},
	...
	nodes: [
		...
		{
			identifier: "lavalink-Backup", // log id string
			host: "94.23.157.216",
			port: 2335,
			password: "s4DarqP$&y",
			retryAmount: 15, // for lavalink connection attempts
